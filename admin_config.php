 ...
 * metard under the terms and conditions of the
 * GNU General Public License (http://www.gnu.org/licenses/gpl.txt)
 *
 * e107 metar Plugin
 *
 * $Source: /cvs_backup/e107_0.8/e107_plugins/metar/admin_config.php,v $
 * $Revision$
 * $Date$
 * $Author$
 *
...
class plugin_METAR_admin extends e_admin_dispatcher
{
	/**
	...
	protected $modes = array(
		'main'		=> array('controller' => 'plugin_METAR_admin_ui',
		'path' 		=> null, 
		'ui' 		=> 'plugin_METAR_admin_form_ui', 'uipath' => null)
	);
	...
	*/
	...
	/**
	 * Format: 'MODE/ACTION' => array('caption' => 'Menu link title'[, 'url' => '{e_PLUGIN}metar/admin_config.php', 'perm' => '0']);
	 ...
	 * @var string
	 */
	protected $menuTitle = 'metar Menu';
}



class plugin_METAR_admin_ui extends e_admin_ui
{
		// required
		protected $pluginTitle = "e107 metar";
		 ...
		 * Maybe we need something like $prefs['core'], $prefs['metar'] ... multiple getConfig support?
		 *
		 * @var string
		 */
		protected $pluginName = 'metar';
		...
		//protected $editQry = "SELECT * FROM #metar WHERE metar_id = {ID}";

		// required - if no custom model is set in init() (primary id)
		protected $pid = "metar_id";
		...
		//TODO change the metar_url type back to URL before metar.
		// required
		/**
		 ...
		 * 		  -> write: [optional] 'nameField' => 'comment_author_name' the name of a 'user_name' field; 'currentInit' - use currrent user if no data provided; 'current' - use always current user(editor); '_options' e_form::userpickup() options
		 *
		 * - number -> read: (array) [optional] 'point' => '.', [optional] 'sep' => ' ', [optional] 'decimals' => 2, [optional] 'pre' => '&euro; ', [optional] 'post' => 'LAN_CURRENCY'
		 * 			-> write: (array) [optional] 'pre' => '&euro; ', [optional] 'post' => 'LAN_CURRENCY', [optional] 'maxlength' => 50, [optional] '_options' => array(...) see e_form class description for _options format
		 *
		 * - ip		-> read: n/a
		 * 			-> write: [optional] element options array (see e_form class description for _options format)
		 *
		 * - text -> read: (array) [optional] 'htmltruncate' => 100, [optional] 'truncate' => 100, [optional] 'pre' => '', [optional] 'post' => ' px'
		 * 		  -> write: (array) [optional] 'pre' => '', [optional] 'post' => ' px', [optional] 'maxlength' => 50 (default - 255), [optional] '_options' => array(...) see e_form class description for _options format
		 *
		 ...
		 * 		  		-> write: (array) [optional] 'rows' => '' default 15, [optional] 'cols' => '' default 40, [optional] '_options' => array(...) see e_form class description for _options format
		 ...
		 * 		   -> write: (array) [optional] 'label' => '', [optional] '_options' => array(...) see e_form::imagepicker() for allowed options
		 *
		 * - icon  -> read: [optional] 'class' => 'S16', [optional] 'pre' => '{e_PLUGIN}myplug/images/'
		 * 		   -> write: (array) [optional] 'label' => '', [optional] 'ajax' => true/false , [optional] '_options' => array(...) see e_form::iconpicker() for allowed options
		 *
    	...
    	protected  $fields = array(
			...
			'metar_id'					=> array('title'=> LAN_ID, 					'type' => 'number',		'data' => 'int',		'width'=>'5%',		'thclass' => '',  'class'=>'center',	'forced'=> TRUE, 'primary'=>TRUE/*, 'noedit'=>TRUE*/), //Primary ID is not editable
           	'metar_icon'				=> array('title'=> LAN_ICON, 			'type' => 'icon',		'data' => 'str',		'width'=>'5%',		'thclass' => '',	'forced'=> TRUE, 'primary'=>TRUE/*, 'noedit'=>TRUE*/), //Primary ID is not editable          
            'metar_type'	   			=> array('title'=> LAN_TYPE, 				'type' => 'method', 	'data' => 'str',		'width'=>'auto',	'thclass' => '', 'batch' => TRUE, 'filter'=>TRUE),
			'metar_folder' 				=> array('title'=> 'Folder', 			'type' => 'text', 		'data' => 'str',		'width' => 'auto',	'thclass' => ''),
			'metar_name' 				=> array('title'=> 'Name', 				'type' => 'text', 		'data' => 'str',		'width' => 'auto',	'thclass' => ''),
			'metar_version' 			=> array('title'=> 'Version',			'type' => 'number', 		'data' => 'str',		'width' => 'auto',	'thclass' => ''),
			'metar_author' 				=> array('title'=> LAN_AUTHOR,			'type' => 'text', 		'data' => 'str',		'width' => 'auto',	'thclass' => 'left'),
         	'metar_authorURL' 			=> array('title'=> "Url", 				'type' => 'url', 		'data' => 'str',		'width' => 'auto',	'thclass' => 'left'),
            'metar_date' 				=> array('title'=> LAN_DATE, 			'type' => 'datestamp', 	'data' => 'int',		'width' => 'auto',	'thclass' => '', 'readParms' => 'long', 'writeParms' => 'type=datetime'),
			'metar_compatibility' 		=> array('title'=> 'Compatible',			'type' => 'text', 		'data' => 'str',		'width' => '10%',	'thclass' => 'center' ),
			'metar_url' 				=> array('title'=> LAN_URL,		'type' => 'file', 		'data' => 'str',		'width' => '20%',	'thclass' => 'center',	'batch' => TRUE, 'filter'=>TRUE, 'parms' => 'truncate=30', 'validate' => false, 'help' => 'Enter metar URL here', 'error' => 'please, ener valid URL'),
		...
		protected $fieldpref = array('checkboxes', 'metar_id', 'metar_type', 'metar_url', 'metar_compatibility', 'options');
		...
		/*protected  $validationRules = array(
			'metar_url' => array('required', '', 'metar URL', 'Help text', 'not valid error message')
		);*/
...
class plugin_METAR_admin_form_ui extends e_admin_form_ui
{
	
	function metar_type($curVal,$mode) // not really necessary since we can use 'dropdown' - but just an example of a custom function.
	{
		$frm = e107::getForm();
		...
		if($mode == 'batch') // Custom Batch List for metar_type
		{
			return $types;
		}

		if($mode == 'filter') // Custom Filter List for metar_type
		{
			return $types;
		}

		return $frm->select('metar_type', $types, $curVal);
	}
 ...
 * NOTE: class is auto-loaded - see class2.php _autoload()
 */
/* $dispatcher = */

new plugin_METAR_admin();

/*
 * Uncomment the below only if you disable the auto observing above
 * Example: $dispatcher = new plugin_METAR_admin(null, null, false);
 */
...
function admin_config_adminmenu() 
{
	//global $rp;
	//$rp->show_options();
	e107::getRegistry('admin/metar_dispatcher')->renderMenu();
}
*/
